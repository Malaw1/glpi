...
<head>
	<meta charset="utf-8">    
	<title><?php echo __('Tickets - Laborex Sénégal'); ?></title>
...
<!--            </form>-->
	...
	<?php
	  echo "</div>"; // end contenu login
	   ...
	   echo "<a href='http://192.168.1.68/' title='Powered By Teclib' style='color:#fff;'>";
	   echo " Copyright (C) 2021 - ".date('Y')." DSI Laborex  Development Team";
	   echo "</a></div>\n"; 
	?>       
